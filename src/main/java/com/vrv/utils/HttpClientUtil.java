...
public class HttpClientUtil {
     ...
     */
    public String post(String url, Map params, String charset, final URL keystoreUrl,
        ...
        try {
            ...
            logger.error("指定的加密算法不可用", e);
        } catch (KeyStoreException e) {
            logger.error("keytore解析异常", e);
        } catch (CertificateException e) {
            logger.error("信任证书过期或解析异常", e);
        } catch (FileNotFoundException e) {
            logger.error("keystore文件不存在", e);
        } catch (IOException e) {
            logger.error("I/O操作失败或中断 ", e);
        } catch (UnrecoverableKeyException e) {
            logger.error("keystore中的密钥无法恢复异常", e);
        } catch (KeyManagementException e) {
            logger.error("处理密钥管理的操作异常", e);
        } finally {
            abortConnection(hp, httpclient);
        }
        return responseStr;
     ...
     * @return keystore 对象
     */
    private KeyStore createKeyStore(final URL url, final String password) throws KeyStoreException,
     ...
     */
    private List getParamsList(Map<String, String> paramsMap) {
    ...
    public String post(String url, String content) {
        ...
        try {
            ...
            logger.debug("请求url:{" + url + "} ;耗时：{" + interval + "} ");
        }
        return info;
    }
