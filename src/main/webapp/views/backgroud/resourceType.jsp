...
<br>
 <div class="clearfix">
            <div class="clearfix  col-xs-12" id="advanced_query" >
                <form class="form-horizontal col-xs-12" role="form" id="orderForm" method="post" action="${url }admin/resource">
                        <!-- 一行开始 -->
                       <div class="form-group">
                            <div class="col-xs-12">
                                <div class="row">
                                    <!-- 一组开始 -->
                                    <div class="col-xs-5">
                                        <label  class="col-xs-4 control-label">资源类别名称:</label>
                                        <div class="col-xs-8 ">
...
$('#page-jq').jqPaginator({
    ...
    onPageChange:function(num,type){
    	if(type == 'change'){
    		...
    		window.location.href="${url }admin/resource?pageNumber="+num+"&catName="+catName;
    	}
    }
});

function addResource(){
	window.location.href="${url}admin/resource/gotoAdd";
}


function edit(id){
	window.location.href="${url}admin/resource/gotoEdit?id="+id;
}

function deleteResource(id){
	$.ajax({
        url : '${url }admin/resource/deleteResourceType',
        type:'post',
        data:{id:id},
