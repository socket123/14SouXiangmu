...
<div class="ibox-content">
    <form id="saveForm" class="form-horizontal m-t">
        <div class="form-group draggable">
            ...
            <div class="col-sm-9">
                <input type="text" name="catName" id="catName" class="form-control" placeholder="请输入分类名称">
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $("#save").on("click",function(){
        if($("#saveForm").valid()){
            ...
            $.ajax({
                url : '${url }admin/carryoutType/addCarryoutType',
                type:'post',
                data:{name:catName,remark:remark,pid:pid,parentid:parentid},
                success:function(result)
                {
                    if(result.message==1){
                        layer.alert("载具分类添加成功!",function(){
