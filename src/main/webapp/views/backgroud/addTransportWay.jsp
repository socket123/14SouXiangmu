...
<div class="ibox-content">
                        <form id="saveForm" class="form-horizontal m-t">
                            <div class="form-group draggable">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="transportType" id="transportType" class="form-control" placeholder="请输入运输方式">
                                </div>
                            </div>
...
$("#save").on("click",function(){
	...
	$.ajax({
        url : '${url }admin/transportWay/addTransportWay',
        type:'post',
        data:{transportType:transportType,remark:remark},
        success:function(result)
        {
          if(result.message==1){
        	 layer.alert("运输方式添加成功!",function(){
        		 window.location.href="${url}admin/transportWay/gotoTransportWayList";
        	 });
          }else{
        	 layer.alert("运输方式添加失败!",function(){
        	 	window.location.href="${url}admin/transportWay/gotoTransportWayList";
        	 });
          }
        }
