...
<div class="ibox-content">
    <form id="saveForm" class="form-horizontal m-t">
        <div class="form-group draggable">
            ...
            <div class="col-sm-9">
                <input type="text" name="catName" id="catName" class="form-control" placeholder="请输入部门名称">
            </div>
        </div>
...
<script type="text/javascript">
    $("#save").on("click",function(){
        if($("#saveForm").valid()){
            ...
            $.ajax({
                url : '${url }admin/carryoutDept/addCarryoutDept',
                type:'post',
                data:{deptName:catName,remark:remark},
                success:function(result)
                {
                    if(result.message==1){
                        layer.alert("部门添加成功!",function(){
